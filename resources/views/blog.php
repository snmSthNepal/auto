...
<!-- Mirrored from themesground.com/motocart-demo/V1/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Feb 2021 17:55:29 GMT -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Motocart Blog List Page</title>
	   ...
	   <div class="input-group-append">
        ...
        <div id="secondary" class="widget_wrapper13" role="complementary">
          ...
          <figure class="featured-thumb"> <a href="#"> <img src="images/blog-img2.jpg" alt="blog image"> </a> </figure>
                 ...
                 <li>
          <figure class="featured-thumb"> <a href="#"> <img src="images/blog-img4.jpg" alt="blog image"> </a> </figure>
                  <!--featured-thumb-->
                  <div class="content-info">
...
<div class="custom-slider">
          ...
          <div class="block widget_recent_entries">		<h2 class="widget-title">Recent Posts</h2>		<ul>
											<li>
  ...
  <ul id="recentcomments">
    <li class="recentcomments"><span class="comment-author-link">John Doe</span> on <a href="#">Awesome template with lot’s of features on the board!</a></li>
    <li class="recentcomments"><span class="comment-author-link">admin</span> on <a href="#">Awesome template with lot’s of features on the board!</a></li>
    <li class="recentcomments"><span class="comment-author-link">admin</span> on <a href="#">Awesome template with lot’s of features on the board!</a></li>
    <li class="recentcomments"><span class="comment-author-link">admin</span> on <a href="#">Fresh Red Seedless</a></li>
    <li class="recentcomments"><span class="comment-author-link">admin</span> on <a href="#">Organic Grape Tomatoes</a></li>
  </ul>
</div>
          ...
          <div class="text-widget widget widget__sidebar block">
            ...
            <div>
           Mauris at blandit erat. Nam vel tortor non quam scelerisque cursus. Praesent nunc vitae magna pellentesque auctor. Quisque id lectus.<br>
              <br>
            ...
            <div id="content" role="main">
              <article id="post-29" class="blog_entry clearfix wow bounceInUp animated animated animated" style="visibility: visible;">
                ...
                <div class="entry-content">
                  <div class="featured-thumb"><a href="#"><img src="images/blog-img1.jpg" alt="blog-img3"></a></div>
              ...
              <article id="post-29" class="blog_entry clearfix wow bounceInUp animated animated animated" style="visibility: visible;">
                ...
                <div class="entry-content">
                  <div class="featured-thumb"><a href="#"><img src="images/blog-img3.jpg" alt="blog-img1"></a></div>
                   <header class="blog_entry-header clearfix">
                  <div class="blog_entry-header-inner">
                  ...
                  <ul class="post-meta">
                    ...
                    <p> Integer vitae diam sed dolor euismod laoreet eget ac felis. Donec non erat sed elit bibendum sodales. Donec eu cursus velit. Proin nunc lacus, gravida mollis dictum ut, vulputate eu turpis. Sed felis sapien, commodo in iaculis in, feugiat sed enim. Sed nunc ipsum, fermentum varius dignissim vitae, blandit et ante.Maecenas sagittis, lorem sed congue egestas, lectus purus congue nisl, ac molestie enim ligula nec eros.</p>
                  </div>
                 <div class="thm-readmore"><a href="#" class="btn">READ MORE</a></div>
                </div>
              </article>              
        ...
        <div class="row">
          <div class="col-sm-4 col-xs-12 col-lg-4">
            <div class="co-info">
              ...
              <div> <span><a href="#">motocart@example.com</a></span></div>
...
<!-- Mirrored from themesground.com/motocart-demo/V1/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Feb 2021 17:55:41 GMT -->
</html>