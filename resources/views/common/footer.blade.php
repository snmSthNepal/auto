                        ...
                        <ul>
                            ...
                            <li class="last">
                                <div class="feature-box">
                                    ...
                                    <div class="content">
                                        <h6>Free Evaluation</h6>
                                        <p>Evaluate your ride</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        ...
                        <div class="col-sm-4 col-xs-12 col-lg-4">
                            <div class="co-info">
                                ...
                                <address>
                                    <div>
                                        <span>
                                            Gatthaghar-8, Bhaktapur, <br>
                                            Kathmandu Nepal
                                        </span>
                                    </div>
                                    <div> <span> 01-6631360 </span></div>
                                    <div> <span><a href="#">hero2218@live.com</a></span></div>
                                    <div> <span>Sun - Fri : 9am to 6pm</span></div>
                                </address>
                            </div>
                        </div>
                        <div class="col-sm-8 col-xs-12 col-lg-8">
                            <div class="footer-column">
                                ...
                                <ul class="links">
                                    ...
                                    <li><a title="query" href="#">Query</Q></a></li>
                                    <li><a title="query" href="view/evaluate.html">Evaluate</Q></a></li>
            ...
            <div class="footer-top">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12 coppyright">&copy; 2019 AutoPoint. All Rights Reserved. </div>
                        <div class="col-xs-12 col-sm-4">
